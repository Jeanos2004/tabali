...
export function CTASection() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-tabali-primary to-tabali-primary-dark py-16 md:py-20 mb-6">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-16">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-5">
              <Link href="/auth/register" className="tabali-hover-lift">
                <motion.button 
                  className="tabali-btn tabali-btn-large group relative overflow-hidden rounded-full bg-white text-tabali-primary hover:shadow-xl"
              ...
              <Link href="/search" className="tabali-hover-lift">
                <motion.button 
                  className="tabali-btn tabali-btn-large group relative overflow-hidden rounded-full border-2 border-white/80 text-white hover:bg-white/10"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
                  <span className="tabali-btn-content flex items-center">
                    Explorer les services
                    <svg className="w-5 h-5 ml-2 opacity-70 group-hover:opacity-100" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-12 flex flex-wrap items-center gap-6">
              <div className="flex items-center bg-white/10 backdrop-blur-md rounded-full px-4 py-1.5 border border-white/20">
          ...
          >
            <div className="bg-white/10 backdrop-blur-md p-8 rounded-2xl border border-white/20 shadow-tabali-lg max-w-md">
              ...
              <Link href="/auth/register?type=provider" className="tabali-hover-lift block">
                <motion.button 
                  className="tabali-btn tabali-btn-accent tabali-btn-large w-full group relative overflow-hidden rounded-full"
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                >
